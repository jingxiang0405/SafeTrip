...
INSERT INTO users (name, sos_phone_number, role, partner_id, password) VALUES
  ('test', '0912-345-678', NULL, NULL, 'test'),
  -- 第一組配對：Alice (caretaker) ↔ Bob (carereceiver)
  ('Alice Chang', '0912-345-678', 'caretaker', 2, 'passAlice1'),
  ('Bob Chang',   '0987-654-321', 'carereceiver', 1, 'passBob1'),

  -- 第二組配對：Carol (caretaker) ↔ David (carereceiver)
  ('Carol Wu',   '0922-111-222', 'caretaker', 4, 'passCarol1'),
  ('David Wu',   '0933-333-444', 'carereceiver', 3, 'passDavid1'),

  -- 第三組：單獨帳號（尚未配對）
  ('Emma Lin',   '0944-555-666', 'caretaker', NULL, 'passEmma1'),
  ('Frank Lin',  '0955-777-888', 'carereceiver', NULL, 'passFrank1');
